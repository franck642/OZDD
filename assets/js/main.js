(function ($) {
    ...
    $('.sort-by').selectric({
        arrowButtonMarkup: '<span class="arrow"><i class="fas fa-angle-down"></i></span>',
        labelBuilder: '<i class="fas fa-align-left"></i> Trier par : <span>{text}</span>',
        disableOnMobile: false,
    });
    ...
    $('[data-countdown]:not(.pro-countdown-1,.pro-countdown-2)').each(function() {
        ...
        $this.countdown(finalDate, function(event) {
            $this.html(event.strftime('<div class="single-countdown-box"><span>%D</span>Jours</div><div class="single-countdown-box"><span>%H</span>Heures</div><div class="single-countdown-box"><span>%M</span>Minutes</div><div class="single-countdown-box"><span>%S</span>Secondes</div>'));
        });
    });
...
window.onclick = function(event) {
    if (!event.target.matches('.far.fa-user-circle')) {
